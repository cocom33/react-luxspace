...
export default function Header({ theme = "white", position }) {
            ...
            <ul className="items-center flex">
              <li className="ml-6 block md:hidden">
                <button
                  className={[
                    ...
                    toggleMainMenu ? "fixed top-5 right-10" : "relative",
                    theme === "white"
                      ? "text-black md:text-white "
              ...
              <li className="ml-6">
                <Link
                  to="/cart"
                  className={[
                    "cart flex items-center justify-center w-8 h-8 text-black md:text-white",
